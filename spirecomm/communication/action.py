...
class LeaveAction(Action):
    """An action to use the CommunicationMod 'Leave' command"""

    def __init__(self):
        super().__init__("leave")

class ReturnAction(Action):
    """An action to use the CommunicationMod 'Return' command"""

    def __init__(self):
        super().__init__("return")

class KeyAction(Action):
    """An action to use the CommunicationMod 'Key' command"""
...
class CardSelectAction(Action):
    ...
    def execute(self, coordinator):
        ...
        for index in chosen_indices:
            ChooseAction(choice_index=index).execute(coordinator)
